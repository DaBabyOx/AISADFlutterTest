  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserDetailsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserDetailsRecord> forgotPassUserDetailsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final forgotPassUserDetailsRecord =
            forgotPassUserDetailsRecordList.isNotEmpty
                ? forgotPassUserDetailsRecordList.first
                : null;
