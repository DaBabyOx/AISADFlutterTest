  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserDetailsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserDetailsRecord> resetPasswordUserDetailsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final resetPasswordUserDetailsRecord =
            resetPasswordUserDetailsRecordList.isNotEmpty
                ? resetPasswordUserDetailsRecordList.first
                : null;
